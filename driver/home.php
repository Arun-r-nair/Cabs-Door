...
<?php
 $dd=  mysqli_query($dbcon,"select * from driver where em='$usr'");
                          $dd1=  mysqli_fetch_row($dd);

                          $sel=  mysqli_query($dbcon,"select * from taxi where id='$dd1[9]'");
...
<!--                                    <div class="col-lg-12">
                                        <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from book where cid='$dd1[9]'and st='0'");
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="home.php?chk1=<?php echo $r_gal[0] ?>"><span style="color: green" class="fa fa-check"></span></a>&nbsp;&nbsp; <a href="home.php?rem1=<?php echo $r_gal[0] ?>"><span style="color: red" class="fa fa-remove"></span></a></td>
                                        </tr>
                                        <?php
                                        ...
                                        <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from book where cid='$dd1[9]'and st='1' and dt='$date'");
                                                        if(mysqli_num_rows($sel_gal)>0)
                                                        {$i=0;
                                                        ?>
                        ...
                        <div class="single-sidebar">
                            ...
                            <div class="sidebar-body">
                                <center>
                                    ...
                                    ?>
                                   &nbsp;&nbsp; <a href="home.php?chk=<?php echo $dd1[0] ?>"><span style="color: green" class="fa fa-check"></span></a>&nbsp;&nbsp; <a href="home.php?rem=<?php echo $dd1[0] ?>"><span style="color: red" class="fa fa-remove"></span></a>
                                </center>
                            </div>
                        </div>
                        <!-- Single Sidebar End -->
...
$log=mysqli_query($dbcon,"select * from driver where em='$usr'");
