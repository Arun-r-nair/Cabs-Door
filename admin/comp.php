                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">User Complaints</strong>
                            </div>
                            <div class="card-body">
                                   <?php
                        
                                                        $sel_gal=mysqli_query($dbcon,"select * from comp order by id desc");
                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                                            ...
                                                            {
                                                                $sel=  mysqli_query($dbcon,"select * from agency where em='$r_gal[8]'");
