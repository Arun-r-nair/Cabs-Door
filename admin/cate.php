...
<?php
                    ...
                    if(isset($_POST['b1']))
 {
   ...
   $t2=$_POST['t2'];
    ...
    $chk=mysqli_query($dbcon,"select * from cate");
    $count=mysqli_num_rows($chk);
    $nfn=$count."".substr($up,strrpos($up,"."));
   
    
     if(move_uploaded_file($_FILES['myFile']['tmp_name'],getcwd()."//../cate//$nfn"))
    {
    $ins=mysqli_query($dbcon,"insert into cate values('','$t1','$t2','$nfn','0')");
                                ...
                                <div id="pay-invoice">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="sub_cate.php?mid=<?php echo $r_gal[0] ?>"><span style="color: green" class="fa fa-plus"></span></a>&nbsp;&nbsp;<a href="cate.php?del=<?php echo $r_gal[0] ?>"><span style="color: red" class="fa fa-trash"></span></a></td>
