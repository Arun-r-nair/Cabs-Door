        ...
        <div class="container">
			<div class="row">
               <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from cate where typ='$typ'");
                ...
                <div class="col-lg-4 col-md-6">
                     <a href="car.php?mid=<?php echo $r_gal[0] ?>">
                    <div class="single-driver-member">
                        <img src="../cate/<?php echo $r_gal[3] ?>" style="width: 100%;height: 400px" alt="Raju Ahammad">
                        <div class="driver-mem-info">
                            
                            <h4><?php echo $r_gal[2] ?><span></span></h4>
                        </div>
                    </div>
                     </a>
                </div>
