        ...
        <div class="container">
            <div class="row">
                ...
                <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from agency where pol='$mid' and st='1'");
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5">
                                <div class="article-thumb">
                                    <img src="../img2/<?php echo $r_gal[12] ?>" alt="JSOFT">
                                </div>
                            </div>
                                    ...
                                    <div class="display-table-cell">
                                        <div class="article-body">
                                            ...
                                            <div class="article-meta">
                                                <a href="#" class="author">HOD :: <span><?php echo $r_gal[2] ?></span></a>
                                                <a href="#" class="commnet">Contact :: <span><?php echo $r_gal[3] ?></span></a>
                                            </div>

                                            <div class="article-date">Book<span class="month">Now</span></div>

                                            <p><?php echo $r_gal[10] ?></p>

                                            <a href="agn.php?aid=<?php echo $r_gal[8] ?> " class="readmore-btn">Book Service <i class="fa fa-long-arrow-right"></i></a>&nbsp;&nbsp;<a href="comp.php?mid=<?php echo $r_gal[8] ?> " class="readmore-btn">Post Complaint <i class="fa fa-envelope"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
