            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="car-list-content">
                        <center>
                            <a href="#"  data-toggle="modal" data-target="#basicModal"><b style="color: red"><img style="width: 60px;height: 60px" src="../image/7jM3.gif">
         </b></a>
                        </center>
                        <br/>
                        <div class="row">
                		...
                		<div class="login-form">
                            ...
                            <div class="username">
                               ...
                               <span id="police">
								...
								<div class="log-btn">
									<button name="b1" type="submit"><i class="fa fa-search"></i> Search Now</button>
								</div>
							</form>
                		</div>
                            ...
                            <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from taxi where cate='$mid' and aid='$agn'");
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="single-car-wrap">
                                    <img style="width: 100%;height: 300px" src="../img4/<?php echo $r_gal[11] ?>">
                                    <div class="car-list-info without-bar">
                                        <h2><a href="#"><?php echo $r_gal[4] ?></a></h2>
                                        <h5>MIN Rate:<?php echo $r_gal[8] ?> Rs/- / Extra Rate:<?php echo $r_gal[9] ?> Rs/-</h5>
                                        <p><?php echo substr($r_gal[7],0,100)?>.....</p>
                                        <ul class="car-info-list">
                                            <li><?php echo $r_gal[5] ?></li>
                                            <li>
                          ...
                          ?>
                                        ...
                                        <p class="rating"></p>
                                        <a href="car_dt.php?mid=<?php echo $r_gal[0] ?>" class="rent-btn">View Details</a>
                                    </div>
                                </div>
                            </div>
                            <?php
