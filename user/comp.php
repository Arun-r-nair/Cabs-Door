...
?>
                    ...
                    if(isset($_POST['sub1']))
 {
   ...
   $t2=$_POST['t2'];
    ...
    $ins=mysqli_query($dbcon,"insert into comp values('','$t1','$t2','$t3','$t4','$t5','$t6','$usr','$mid','1')");
...
<div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="subject-input">
                                        <input type="number" name="t5"required="" placeholder="Contact">
                                    </div>
                                </div>
                            </div>
                            <br/>
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <div class="name-input">
                                        <textarea cols="3"rows="3" name="t6"placeholder="Message"></textarea>
                                    </div>
                                </div>
