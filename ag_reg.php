                    ...
                    if(isset($_POST['sub1']))
 {
   ...
   $t2=$_POST['t2'];
    ...
    $t8=$_POST['t8'];
     ...
     $log1=mysqli_query($dbcon,"select * from agency where aadr='$t7'");
if(mysqli_num_rows($log1)>0)
{
   header("location:ag_reg.php?adr=1"); 
}
 else {
    
$log2=mysqli_query($dbcon,"select * from user_log where uid='$t8'");
if(mysqli_num_rows($log2)>0)
{
   header("location:ag_reg.php?fail=1"); 
}
 else {
    
    $up=$_FILES['myFile']['name'];
    $chk=mysqli_query($dbcon,"select * from agency");
    $count=mysqli_num_rows($chk);
    $nfn=$count."".substr($up,strrpos($up,"."));
   
    $up1=$_FILES['myFile1']['name'];
    $chk1=mysqli_query($dbcon,"select * from agency");
    ...
    $ins=mysqli_query($dbcon,"insert into agency values('','$t1','$t2','$t3','$t4','$t5','$t6','$t7','$t8','$t9','$t10','$nfn','$nfn1','0')");
    
    if($ins>0)
    {
      $ins1=mysqli_query($dbcon,"insert into user_log values('','$t8','$t9','agency','0')");
        if($ins1>0)
        {
                header("location:ag_reg.php?suss=1");
            }
    }
        }
 }
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <div class="name-input">
                                        <input type="text" name="t1"required=""placeholder="Agency Name">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="subject-input">
                                        <input type="text" name="t2"required="" placeholder="Contact Person">
                                    </div>
                                </div>

                                <div class="col-lg-6 col-md-6">
                                    <div class="subject-input">
                                        <input type="text" name="t3"required="" placeholder="Contact Number" onkeyup="chkc(this.value)" /><span id="o3"></span>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    <script type="text/javascript">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <div class="name-input">
                                        <input type="text"placeholder="Aadhar Number"name="t7"required="required"onkeyup="chkd(this.value)" /><span id="p3"></span>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="name-input">
                                        <input type="text"placeholder="Email"name="t8"required="required"onkeyup="vem(this.value)" /><span id="em"></span>
                                    </div>
                                </div>

                                <div class="col-lg-6 col-md-6">
                                    <div class="name-input">
                                        <input type="password"placeholder="Password"name="t9"required="required">
                                    </div>
                                </div>
                            </div>
                            <br/>
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <div class="name-input">
                                        <textarea cols="3"rows="3" name="t10"placeholder="Discription"></textarea>
                                    </div>
                                </div>
