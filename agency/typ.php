        ...
        <div class="container">
			<div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <a href="cate.php?typ=1">
                    <div class="single-driver-member">
                        <img src="../image/781967.jpg" style="width: 100%;height: 500px" alt="Raju Ahammad">
                        <div class="driver-mem-info">
                            
                            <h4>Taxi Service <span>Click Now!!!</span></h4>
                        </div>
                    </div>
                     </a>
                </div>
                ...
                <!-- Single Driver Start-->
                <div class="col-lg-6 col-md-6">
                     <a href="cate.php?typ=2">
                    <div class="single-driver-member">
                        <img src="../image/white-volvo-semi-truck-on-side-of-road-2199293.jpg"style="width: 100%;height: 500px" alt="Raju Ahammad">
                        <div class="driver-mem-info">
                            
                            <h4>Loading Service <span>Click Now!!!</span></h4>
                        </div>
                    </div>
                     </a>
                </div>
