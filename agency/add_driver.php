...
{
   header("location:add_driver.php?fail=1&mid=$mid"); 
}
 else {                     
    ...
    $ins=mysqli_query($dbcon,"insert into driver values('','$t1','$t2','$t3','$t4','$t5','$t6','$nfn','$nfn1','$mid','$usr','1')");
    
    if($ins>0)
    {
        $ins1=mysqli_query($dbcon,"insert into user_log values('','$t4','123','driver','1')");
        if($ins1>0)
        {
