                    ...
                    if(isset($_POST['sub1']))
 {
   ...
   $t2=$_POST['t2'];
    ...
    $t8=$_POST['t8'];
     $t9=$_POST['t9'];
     $t10=$_POST['t10'];
     $log1=mysqli_query($dbcon,"select * from user_data where aadr='$t7'");
if(mysqli_num_rows($log1)>0)
{
   header("location:user_reg.php?adr=1"); 
}
 else {
...
{
   header("location:user_reg.php?fail=1"); 
}
 else {
    ...
    {
          if(move_uploaded_file($_FILES['myFile1']['tmp_name'],getcwd()."//img8//$nfn1"))
    {
         
    $ins=mysqli_query($dbcon,"insert into user_data values('','$t1','$t2','$t3','$t4','$t5','$t6','$t7','$t8','$t9','$t10','$nfn','$nfn1','0')");
    
    if($ins>0)
    {
      $ins1=mysqli_query($dbcon,"insert into user_log values('','$t8','$t9','usr','1')");
        if($ins1>0)
        {
                header("location:user_reg.php?suss=1");
            }
    }
        }
 }
...
<script type="text/javascript">
    ...
    <script type="text/javascript">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <div class="name-input">
                                        <textarea cols="3"rows="3" name="t10"placeholder="Address"></textarea>
                                    </div>
                                </div>
