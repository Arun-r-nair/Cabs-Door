...
{
                                 $upd=$_GET['del'];
   $upd3=mysqli_query($dbcon,"update agency set st='2'where em='$upd'");
    
   
    if($upd3>0)
    {
        $upd4=mysqli_query($dbcon,"update user_log set st='2'where uid='$upd'");
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Registered Agency</strong>
                            </div>
                            <div class="card-body">
                                   <?php
                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="car.php?mid=<?php echo $r_gal[8] ?>"><span style="color: darkorange" class="fa fa-taxi"></span></a>&nbsp;&nbsp;
                                                <?php
                                                if($r_gal[13]=="1")
                                                {
                                                ?>
                                                <a href="agn.php?del=<?php echo $r_gal[8] ?>"><span style="color: red" class="fa fa-remove"></span> <b style="color: green">Approved</b></a></td>
                                        ...
                                        <?php
                                                ...
                                                {
                                                ?>
                                        <a href="agn.php?upd=<?php echo $r_gal[8] ?>"><span style="color: green" class="fa fa-check"></span> <b style="color: red">Blocked</b></a></td>
                                        <?php
                                                }
                                                ?>
                                        </tr>
